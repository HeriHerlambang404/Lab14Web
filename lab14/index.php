...
$resultTotal = mysqli_query($conn, "SELECT id FROM produk $condition");
...
$query = "SELECT * FROM produk $condition ORDER BY id DESC LIMIT $awalData, $jumlahDataPerHalaman";
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="fw-bold text-secondary m-0">Daftar Stok Barang</h3>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if(mysqli_num_rows($result) > 0) : ?>
                            ...
                            <?php endwhile; ?>
                        <?php else : ?>
                            <tr><td colspan="6" class="text-center py-5 text-muted">Barang yang lu cari nggak ada, Bro.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
